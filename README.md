...
Once application is successfully pushed on to pivotal cloud foundry. 
Update the app by binding it to a service.

Restage the application using following command.
