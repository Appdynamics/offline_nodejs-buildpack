...
def preprocess_commands(ctx):
    ...
    if detected == True: 
        mylist = ["require('appdynamics').profile({","controllerHostName: '52.33.129.11',","controllerPort: 8090,","accountName: 'customer1',","accountAccessKey: 'e47c0e60-6e7d-41ad-8c64-0ae0d2f6708b',","applicationName: 'node_js_test2',","tierName: 'test',","nodeName: 'process'","});"]
